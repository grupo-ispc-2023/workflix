...
class UsuarioClienteEntity(Usuario):
    def __init__(self, id, nombre, apellido, email, contrasena, telefono, fotoPerfil, 
    rol, provincia, ciudad):
        super().__init__(id, nombre, apellido, email, contrasena, telefono, fotoPerfil, 
        rol, provincia, ciudad)
